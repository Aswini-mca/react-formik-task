...
},
{
  ...
  dob: "13-04-1990",
  biography: "What has sharad done for computer science? the TeX typesetting language Donald Knuth is an American mathematician and computer scientist most famous for his contributions to the study of algorithms and inventing the TeX typesetting language."
...
const formValidationSchema = yup.object({
  ...
  .max(15, "Maximum charcter exceeds for name")
  .required("Required to fill author name"),
  dob: yup.string().min(10, "Enter dd-mm-yyyy format")
  .max(10, "Format dd-mm-yyyy, you crossed maximum charcters")
  .required("Required to fill dob"),
  biography: yup.string().min(15, "Need minimum 15 characters for biography")
  .max(100, "Maximum charcters exceeds for biography")
    ...
    <div className="container-fluid">
      ...
      <form onSubmit={formik.handleSubmit}>
        <input class="form-control" type="text"
          ...
          value={formik.values.author_name}/><br />
        ...
        {formik.touched.biography && formik.errors.biography ? formik.errors.biography : ""}<br/>
